                ...
                case 2:
                    if (listaprodutos.size() > 0) {
                        for (produtos produto : listaprodutos) {
                            ...
                            System.out.println("O valor total da compra é de: R$" + valordamercadoria);
                        }
                    }
                    break;
                case 3:
                    ...
                    break;
                case 4:
                    produtos p0 = new produtos(1, "Cachorro Quente", 4.00);
                    p0.mostrarDados();
                    listaprodutos.add(p0);
                    produtos p2 = new produtos(2, "X-Salada", 4.50);
                    p2.mostrarDados();
                    listaprodutos.add(p2);
                    produtos p3 = new produtos(3, "X-Bacon", 5.00);
                    p3.mostrarDados();
                    listaprodutos.add(p3);
                    produtos p4 = new produtos(4, "Torrada Simples", 2.00);
                    p4.mostrarDados();
                    listaprodutos.add(p4);
                    produtos p5 = new produtos(4, "Refrigerante", 1.50);
                    p5.mostrarDados();
